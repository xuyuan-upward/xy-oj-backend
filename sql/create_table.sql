...
(
    ...
    content    text                               null comment '内容',
    tags       varchar(1024)                      null comment '标签列表（json 数组）',
    answer   int      default 0                 not null comment '答案',
    userId   int                    not null comment '创建用户 Id',
    submitNum  int      default 0                 not null comment '提交人数',
    acceptedNum     bigint                             not null comment '通过人数',
    thumbNum     bigint                             not null comment '点赞人数',
    favourNum     bigint                             not null comment '收藏人数',
